...
import coop.tecso.examen.service.EmailVerificationTokenService;
...
public class OnUserRegistrationCompleteListener implements ApplicationListener<OnUserRegistrationCompleteEvent> {
    ...
    private static final Logger logger = LogManager.getLogger(OnUserRegistrationCompleteListener.class);
